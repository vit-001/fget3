...
from view_qt5.log.log_window import LogViewWindow
from view_qt5.history_view.history_view import HistoryView
from view_qt5.thumb_view.thumb_view import ThumbView
from view_qt5.widgets.button_line import ButtonLine

from view_qt5.qt_ui.ui_main_window import Ui_MainWindow
...
class MainWindow(QMainWindow):
    ...
    def create_widgets(self):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("view_qt5/resource/icons/ic_add_box_white_48dp.png"), QIcon.Normal, QIcon.Off)
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("view_qt5/resource/icons/ic_arrow_drop_up_white_24dp.png"), QIcon.Normal, QIcon.Off)
        icon.addPixmap(QPixmap("view_qt5/resource/icons/ic_arrow_drop_down_white_24dp.png"), QIcon.Normal, QIcon.On)
