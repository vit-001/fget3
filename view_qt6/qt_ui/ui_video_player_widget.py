...
# Form implementation generated from reading ui file 'D:/repo/fget3/view_qt5/qt_design/video_player_widget.ui'
#
...
"            ")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../resource/icons/ic_play_arrow_black_48dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../resource/icons/ic_pause_black_24dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../resource/icons/ic_stop_black_24dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../resource/icons/ic_volume_up_black_48dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon3.addPixmap(QtGui.QPixmap("../resource/icons/ic_volume_off_black_48dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../resource/icons/ic_high_quality_black_48dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.bn_quality.setIcon(icon4)
        self.bn_quality.setIconSize(QtCore.QSize(32, 32))
        self.bn_quality.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.MenuButtonPopup)
        self.bn_quality.setAutoRaise(True)
        self.bn_quality.setArrowType(QtCore.Qt.ArrowType.NoArrow)
        ...
        self.progress.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.progress.setObjectName("progress")
        self.bottom_frame_layout.addWidget(self.progress)
        self.lb_time = QtWidgets.QLabel(self.bottom_frame)
        self.lb_time.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        ...
        self.buffer.setOrientation(QtCore.Qt.Orientation.Vertical)
