...
# Form implementation generated from reading ui file 'D:/repo/fget3/view_qt5/qt_design/history_view.ui'
#
...
class Ui_HistoryView(object):
    def setupUi(self, HistoryView):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../resource/icons/ic_backspace_white_48dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../resource/icons/ic_forward_white_48dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
