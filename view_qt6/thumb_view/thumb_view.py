...
from view_qt6.base_view import BaseView
from view_qt6.widgets.thumb_widget import ThumbWidgetVS
...
class ThumbView(BaseView):
    ...
    def prepare_content(self):
        ...
        self.progress.add_progress('thumbs',Qt.GlobalColor.darkBlue)
