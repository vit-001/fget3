...
class TprnSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('3prn.com/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/tprn.png',
                              # menu_items=menu_items,
                              url=URL("https://3prn.com/", test_string='porn'))
