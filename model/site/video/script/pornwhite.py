...
class PornwhiteSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('pornwhite.com/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/pornwhite.png',
                              # menu_items=menu_items,
                              url=URL("https://www.pornwhite.com/latest-updates/", test_string='porn'))
    ...
    def parse_video_tags(self, soup: BeautifulSoup, url: URL):
        ...
        container = soup.find('div', {'class': 'video-holder'})
        if container:
