...
class PornbimboSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('pornbimbo.com/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/pornbimbo.png',
                              # menu_items=menu_items,
                              url=URL("http://pornbimbo.com/latest-updates/", test_string='Porn'))
