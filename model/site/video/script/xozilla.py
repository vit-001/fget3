...
class XozillaSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('xozilla.xxx/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/xozilla.png',
                              # menu_items=menu_items,
                              url=URL("https://www.xozilla.xxx/latest-updates/", test_string='porn'))
    ...
    def parse_thumbs(self, soup: BeautifulSoup, url: URL):
        ...
        if contents:
            # pretty(contents)
            for thumbnail in _iter(contents.find_all('a', {'class': 'item'})):
