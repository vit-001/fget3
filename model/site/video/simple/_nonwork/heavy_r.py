...
class HeavyRSite(BaseSiteParser):
    @staticmethod
    ...
    def create_start_button(view: ViewManagerFromModelInterface):
        ...
        view.add_start_button(picture_filename='model/site/resource/heavy-r.png',
                              menu_items=menu_items,
                              url=URL("https://www.heavy-r.com/videos/", test_string='porn'))
