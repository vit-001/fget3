...
class HdpornSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('hdporn-movies.com/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/hdporn.png',
                              # menu_items=menu_items,
                              url=URL("https://hdporn-movies.com/videos/", test_string='Porn'))
    ...
    def parse_video_tags(self, soup: BeautifulSoup, url: URL):
        ...
        if container:
            pretty(container)
            for tag in _iter(container.find_all('a', {'class':'tag'})):
                pretty(tag)
