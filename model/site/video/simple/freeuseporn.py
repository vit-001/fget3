...
class FreeusepornSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('freeuseporn.com/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/freeuseporn.png',
                              # menu_items=menu_items,
                              url=URL("https://www.freeuseporn.com/videos", test_string='Porn'))
    ...
    def get_pagination_container(self, soup: BeautifulSoup) -> BeautifulSoup:
        return soup.find('div',{'class':'n-pagination'})
    ...
    def parse_video_tags(self, soup: BeautifulSoup, url: URL):
        ...
        for container in _iter(soup.find_all('div', {'class':'tags'})):
            # psp(container)
