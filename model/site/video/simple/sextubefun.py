...
class SextubefunSite(BaseSiteParser):
    @staticmethod
    def can_accept_url(url: URL) -> bool:
        return url.contain('sextubefun.com/')
    ...
    def create_start_button(view:ViewManagerFromModelInterface): #
        ...
        view.add_start_button(picture_filename='model/site/resource/sextubefun.png',
                              # menu_items=menu_items,
                              url=URL("https://sextubefun.com/videos/", test_string='porn'))
    ...
    def parse_thumbs(self, soup: BeautifulSoup, url: URL):
        ...
        if contents:
            ...
            for thumbnail in _iter(soup.find_all('div', {'class': '-video'})):
                ...
                hd_tag = thumbnail.find('span', {'class': 'q-hd'})
